...
```
    ...
    ##  -9.581  -1.242   1.563   1.306   3.823   9.206

``` r
str(x)
```

    ##  num [1:100] -2.27 4.08 3.03 1.41 7.68 ...
...
```
    ...
    ##  num [1:10, 1:10] -0.666 -2.477 -0.953 2.134 1.141 ...

``` r
m[, 1]
```

    ##  [1] -0.6655731 -2.4769518 -0.9530112  2.1337725  1.1405315 -0.2402320
    ##  [7]  1.9388436  0.5903883 -0.7157408 -1.3633586
...
```
    ...
    ##  [1] -2.6310966  0.8965242  1.0396488  0.1602880  2.5273542  0.4112159
    ##  [7] -1.1076047  0.3500768 -0.8223626 -0.7855112
...
```
    ...
    ##  [1] 22.14970 17.43181 20.40837 18.72440 20.50124 20.30938 18.72609 19.58470
    ##  [9] 20.81722 16.48791
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##   16.49   18.72   19.95   19.51   20.48   22.15
