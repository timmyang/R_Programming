...
```
    ...
    ##  -7.000  -0.456   2.507   1.983   4.546   9.444

``` r
str(x)
```

    ##  num [1:100] -4.943 5.876 -0.445 1.983 4.41 ...
...
```
    ...
    ##  num [1:10, 1:10] 1.6522 -0.3536 -0.0701 -0.3969 0.6491 ...

``` r
m[, 1]
```

    ##  [1]  1.65218471 -0.35362217 -0.07007378 -0.39694144  0.64913183  0.10621324
    ##  [7]  0.86276299  1.61589551 -0.16015612 -0.91418304
...
```
    ...
    ##  [1] -1.24682699  1.91642127  0.41920472  0.39066650 -0.48378380  0.64528600
    ##  [7] -0.47888068 -0.02069002  0.78036747  0.15950049
...
```
    ...
    ##  [1] 19.15330 18.58769 16.66447 19.57219 19.61649 19.01649 17.61712 17.57402
    ##  [9] 17.04193 17.14207
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##   16.66   17.25   18.10   18.20   19.12   19.62
