...
```
    ...
    ## -8.5504 -0.5826  1.7994  1.5987  3.9968 11.5913

``` r
str(x)
```

    ##  num [1:100] -2.99 11.59 -4.46 3.7 3.27 ...
...
```
    ...
    ##  num [1:10, 1:10] -0.798 -0.127 -0.379 -0.961 -0.814 ...

``` r
m[, 1]
```

    ##  [1] -0.7979561 -0.1273479 -0.3792849 -0.9606782 -0.8144192  1.2055954
    ##  [7]  0.4394852  0.9309280 -0.2185728  1.0874671
...
```
    ...
    ##  [1] -0.88230972 -0.19886350  0.20022461  0.72725253  0.15897871  1.01283090
    ##  [7]  0.05916557  0.11976461 -1.08972099  1.76096316
...
```
    ...
    ##  [1] 19.88305 22.59113 18.49104 16.66294 26.00988 18.65851 20.31423 20.08207
    ##  [9] 14.96360 17.14875
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##   14.96   17.48   19.27   19.48   20.26   26.01
